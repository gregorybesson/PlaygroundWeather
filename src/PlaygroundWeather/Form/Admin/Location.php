...
class Location extends ProvidesEventsForm
{
    ...
    public function __construct ($name = null, ServiceManager $sm, Translator $translator)
    {
        ...
        $hydrator = new DoctrineHydrator($entityManager, 'PlaygroundWeather\Entity\Location');
        ...
        $this->add(array(
            ...
            'name'    => 'city',
            'options' => array(
                'label' => $translator->translate('Ville', 'playgroundweather'),
            )
        ));
        ...
        $this->add(array(
            ...
            'name'    => 'country',
            'options' => array(
                'label' => $translator->translate('Pays', 'playgroundweather'),
            )
        ));
